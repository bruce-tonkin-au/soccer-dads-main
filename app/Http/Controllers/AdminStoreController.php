...
class AdminStoreController extends Controller
{
    ...
    {
        // The full refund transaction (Stripe + stock restore) now lives on the
        // Order model so this legacy path and the Filament OrderResource action
        // share one implementation. Messages/behaviour are unchanged.
        $order = Order::findOrFail($orderID);

        $result = $order->processRefund();

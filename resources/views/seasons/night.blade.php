...
@php
    ...
    foreach($results as $r) {
        ...
        if (!$r->scoringEnded && $r->homeGoals == 0 && $r->awayGoals == 0) continue;
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #f0f0f0;">
                        ...
                        @php
                            ...
                            foreach($games as $g) {
                                // Skip games not yet played: no goals and no official end time
                                if (!$g->scoringEnded && $g->homeGoals == 0 && $g->awayGoals == 0) continue;
            ...
            <table id="events-table" style="width:100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                $t = max(0, $youtubeOffset + (int) \Carbon\Carbon::parse($youtubeStart)->diffInSeconds(\Carbon\Carbon::parse($action->actionTime)));
                            @endphp

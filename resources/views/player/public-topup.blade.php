...
<div style="background:#262c39; padding:3rem 2rem;">
    <div class="container">
        <a href="/reg/{{ $member->memberCode }}" style="font-size:13px; color:rgba(255,255,255,0.5); text-decoration:none; display:inline-flex; align-items:center; gap:6px; margin-bottom:1.5rem;">
            <i class="fa-solid fa-chevron-left"></i> Back
        </a>
        <div style="font-size:16px; color:rgba(255,255,255,0.6); margin-bottom:4px;">Hi {{ $member->memberNameFirst }}!</div>
...
<div style="padding:3rem 2rem;">
    <div class="container" style="max-width:480px;">
        ...
        <div style="background:#fff3f3; border:1px solid #e24b4a; border-radius:8px; padding:12px 16px; margin-bottom:1.5rem; font-size:14px; color:#262c39;">
            <i class="fa-solid fa-triangle-exclamation" style="color:#e24b4a;"></i> {{ session('error') }}
        </div>
        @endif
        ...
        <div style="background:#fff; border:1px solid #e8e8e8; border-radius:16px; padding:2rem;">
            ...
            <form method="POST" action="/topup/{{ $member->memberCode }}/create" id="topup-form">
                @csrf
